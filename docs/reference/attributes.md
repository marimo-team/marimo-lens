...
| `data-marimo-lens-scope`          | A container                              | CSS selector for preferred grouping roots. A click inside selects the nearest matching root, or the nearest rendered block otherwise. | 1,024 code units                                                  |
