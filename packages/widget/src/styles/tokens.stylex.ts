...
const light = {
  ...
  controlSurface: "var(--background, #ffffff)",
  controlHover: "var(--grass-2, #f5fbf5)",
  controlBorder: "var(--slate-7, #cdced6)",
  controlBorderHover: "var(--grass-7, #94ce9a)",
  controlAccent: "var(--grass-11, #2a7e3b)",
  primary: "#0880ea",
  primarySolid: "#0b68cb",
...
export const darkTheme = stylex.createTheme(colors, {
  ...
  controlSurface: "var(--background, #181c1a)",
  controlHover: "var(--grass-2, #141a15)",
  controlBorder: "var(--slate-7, #43484e)",
  controlBorderHover: "var(--grass-7, #366740)",
  controlAccent: "var(--grass-11, #71d083)",
